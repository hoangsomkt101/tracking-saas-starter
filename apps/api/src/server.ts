...
function getPostbackAmount(payload: AnyRecord, e: AnyRecord) { const partnerStackMoney = getPartnerStackConversionMoney(payload); return serializeMoneyValue(partnerStackMoney?.payoutAmount ?? getPayloadMoney(payload, ['Amount', 'amount', 'saleAmount', 'sale_amount', 'orderAmount', 'order_amount', 'customerAmount', 'customer_amount', 'value']) ?? e.spendAmount) }
function getPostbackPayout(payload: AnyRecord, e: AnyRecord) { const partnerStackMoney = getPartnerStackConversionMoney(payload); return serializeMoneyValue(partnerStackMoney?.commissionAmount ?? getPayloadMoney(payload, ['Payout', 'payout', 'payoutAmount', 'payout_amount', 'commissionAmount', 'commission_amount', 'commission']) ?? e.payoutAmount ?? e.commissionAmount) }
