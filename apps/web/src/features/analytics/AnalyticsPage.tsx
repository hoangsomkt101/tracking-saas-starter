...
import { Activity, BarChart3, Building2, CalendarClock, CircleDollarSign, Download, Globe2, Link2, Megaphone, MousePointerClick, Plus, ShieldCheck } from 'lucide-react'
  ...
  return (
    <>
      ...
      <section className="single-page-grid">
        ...
        <AnalyticsTable title={<><Building2 size={18} /> By brand / offer</>} description="Performance per offer after click UUID attribution." rows={breakdown.byBrand} />
