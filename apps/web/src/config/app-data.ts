...
export const defaultEventFilters: EventFilters = { search: '', startDate: '', endDate: '', campaignId: '', trackingLinkId: '', affiliatePlatformId: '', affiliateRefId: '', affiliateRefSource: '', status: '' }
...
export const defaultAnalyticsSummary: AnalyticsSummary = { clicks: 0, conversions: 0, attributedConversions: 0, unattributedConversions: 0, capiTotal: 0, capiDelivered: 0, capiFailed: 0, conversionRate: 0, attributedConversionRate: 0, revenue: 0, payout: 0, commission: 0, spend: 0, refIds: 0, partnerStackRefIds: 0, impactRefIds: 0, refIdConversions: 0 }
export const defaultAnalyticsBreakdown: AnalyticsBreakdown = { summary: defaultAnalyticsSummary, byCampaign: [], byBrand: [], byPlatform: [], byRefId: [], byDay: [], funnel: [], comparison: null }
